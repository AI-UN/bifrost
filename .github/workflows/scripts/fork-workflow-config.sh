...
fork_set_workflow_defaults() {
  ...
  GENERATED_BRANCH="${GENERATED_BRANCH:-$detected_default_branch}"
  ...
  export UPSTREAM_REPO UPSTREAM_BRANCH PATCH_BRANCH GENERATED_BRANCH GHCR_REGISTRY GHCR_IMAGE_NAME
