...
<CardGroup cols={2}>
  ...
  <Card title="Bifrost as an MCP Gateway" icon="server" href="/mcp/overview#bifrost-as-an-mcp-gateway">
...
<CardGroup cols={2}>
  ...
  <Card title="Datadog Connector" icon="dog" href="/features/observability/datadog">
...
<CardGroup cols={3}>
  ...
  <Card title="Databricks" icon="database" href="/providers/supported-providers/databricks">
    Model Serving and Unity AI Gateway with PAT or OAuth M2M auth.
  </Card>
  ...
  <Card title="SiliconFlow" icon="s" href="/providers/supported-providers/siliconflow">OpenAI-compatible chat, embeddings, rerank, audio, image, video, files, and batch APIs.</Card>
  <Card title="SiliconFlow CN" icon="s" href="/providers/supported-providers/siliconflow-cn">The mainland China SiliconFlow service, with its own accounts, keys, and model catalogue.</Card>
