...
| Cursor | Routes and governs AI requests from the Cursor editor. |
...
| Application | What Edge does |
| --- | --- |
| Claude Code | Routes and governs AI traffic from the Claude Code CLI agent. |
| Codex CLI | Routes and governs AI traffic from the Codex command-line agent. |
| OpenCode | Routes and governs AI traffic from the OpenCode agent. |
...
<CardGroup cols={3}>
  ...
  <Card title="DeepInfra" icon="cloud" href="/providers/supported-providers/deepinfra" />
