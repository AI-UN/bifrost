...
const (
	...
	BifrostContextKeyStreamBodyExhausted                 BifrostContextKey = "stream_body_exhausted"          // bool (set by the idle-timeout reader once the upstream body returns io.EOF) - tells ReleaseStreamingResponse not to drain a stream fasthttp cannot safely re-read
